        ...
        <el-table :data="showData" stripe style="width: 100%">
          ...
          <el-table-column prop="type" label="分类" width="180">
            <template  #default="scope">
                <el-select v-model="scope.row.type" clearable placeholder="请选择" @blur="updateType(scope.row)">
                    <el-option
                        v-for="item in types"
                        :key="item"
                        :label="item"
          ...
          <el-table-column prop="level" label="重要程度" width="180">
            <template  #default="scope">
                <el-select v-model="scope.row.level" clearable placeholder="请选择" @blur="updateLevel(scope.row)">
                    <el-option
                        v-for="item in levels"
                        :key="item"
                        :label="item"
